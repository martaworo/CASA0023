...
In line with NASA definition, remote sensing can be concluded as acquiring information from a distance which can be obtained via sensors. Remote sensors are devices that make use of electromagnetic spectrum (Figure 1) and atmospheric transmission windows in order to observe a chosen target. Most remote sensors measure either an intensity change or a phase change of EM radiation.
...
Another interesting realisation is the amount of objects located in the atmosphere. This raises questions whether there are sufficient policies in place that would regulate the amount of cluster, control its life cycle and ensuring suitable recycling or removal.
