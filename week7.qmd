...
the inherent disadvantage of CNNs is the need for a large number of spatially labeled samples as it has been observed by  Gallo et al. (2023) Nevertheless, different studies which focused on using a different algorithm, e.g. @wei2023early who used RF algorithm also on Sentinel 2 data, was able to achieve a significantly higher accuracy. Their study was based on random forest importance and normalization, which concluded in a strong performance for early crop mapping. 
