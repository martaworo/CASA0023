...
In line with NASA definition, remote sensing can be concluded as acquiring information from a distance which can be obtained via sensors. They are able to make use out of electromagnetic spectrum (Figure 1) and atmospheric windows in order to observe a chosen target.
...
Before the Sun's energy reaches the Earth's surface, following interactions happen: absorption, transmission and scattering. The energy transmitted is then either absorbed by the surface material or reflected. The reflected energy is subject to scattering and absorption in the atmosphere before reaching the remote sensor.
...
Amount of cluster in the atmosphere
